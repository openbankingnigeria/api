...
@RestController
@RequestMapping(value = apiPrefix+"/atms")
@Api(value = apiPrefix+"/atms", description = "ATM related operations", produces = "application/json", consumes = "application/json", tags = {"atm"})
